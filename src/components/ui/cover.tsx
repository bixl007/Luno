...
export const Cover = ({
  ...
  }, []); // Fix: remove ref.current from dependency array
  ...
  return (
    <div
      ...
      ref={ref}
      className="relative hover:bg-purple-900  group/cover inline-block bg-purple-900/40 px-2 py-2  transition duration-200 rounded-sm"
    >
      <AnimatePresence>
        {hovered && (
          <motion.div
          ...
          >
            <motion.div
              animate={{
                x: ["-50%", "0%"], // Changed translateX to x
              }}
              transition={{
                x: { // Changed translateX to x
                  duration: 10,
                  ease: "linear",
                  repeat: Infinity,
                },
